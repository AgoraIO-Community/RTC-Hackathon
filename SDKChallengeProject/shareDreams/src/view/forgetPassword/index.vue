          ...
          <div class="register-form">
            <div class="form">
              ...
              <div class="content">
                ...
                <div class="password">
                  <p>新密码</p><input type="password" v-model="accountData.userPassword"/>
                </div>
                <div class="password">
                  <p>验证密码</p><input type="password" v-model="accountData.checkPassword"/>
                </div>
              </div>
              <div class="register" v-loading='loading' @click="handleReset" element-loading-background="black"><p>重置</p></div>
              <div class="tips">
      ...
      if (this.accountData.phoneNumber !== '') {
        if (this.accountData.captcha !== '') {
          if (this.accountData.userPassword !== '' && this.accountData.checkPassword !== '') {
            if (this.accountData.userPassword === this.accountData.checkPassword) {
              API.users.resetPassword({phoneNumber: this.accountData.phoneNumber, userPassword: this.accountData.userPassword, captcha: this.accountData.captcha}, (responseData) => {
                console.log(responseData)
