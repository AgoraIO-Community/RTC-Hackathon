...
__vue_options__.__file = "F:\\OneDrive\\Code\\RTC2020-Demo\\Commit\\Xeducation\\Mobile\\src\\index.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
...
module.exports = {
  ...
  "back": {
    "height": "300",
    "width": "750",
    "backgroundImage": "linear-gradient(to top, #29bdd9, #276ace)",
    "display": "flex",
...
exports.default = {
  components: { WxcTabBar: _weexUi.WxcTabBar, WxcSimpleFlow: _weexUi.WxcSimpleFlow, WxcCell: _weexUi.WxcCell },
  data: function data() {
    return {
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('wxc-tab-bar', {
    ...
    staticClass: ["item-container"],
    style: _vm.contentStyle
  }, [_c('list', _vm._l((_vm.newsData), function(item) {
    return _c('cell', {
      appendAsTree: true,
      attrs: {
        "append": "tree"
    ...
    staticClass: ["StaLabel"]
  }, [_vm._v("18")]), _c('text', {
    staticClass: ["StaContent"]
  }, [_vm._v("本周剩余课时")])]), _c('div', {
    staticClass: ["Statistics"]
  }, [_c('text', {
    staticClass: ["StaLabel"]
  }, [_vm._v("5")]), _c('text', {
