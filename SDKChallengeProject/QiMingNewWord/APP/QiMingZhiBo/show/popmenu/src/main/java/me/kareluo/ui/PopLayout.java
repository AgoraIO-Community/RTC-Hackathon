...
public class PopLayout extends FrameLayout implements View.OnLayoutChangeListener {
    ...
    private static final Xfermode MODE = new PorterDuffXfermode(PorterDuff.Mode.DST_OUT);
    ...
    private void resetMask() {
        ...
        mPopMaskDiffPath = new Path();
        mPopMaskDiffPath.addRect(0, 0, width, height, Path.Direction.CW);
        mPopMaskDiffPath.op(mPopMaskPath, Path.Op.DIFFERENCE);
    }
    ...
    public void draw(Canvas canvas) {
        ...
        super.draw(canvas);
        canvas.drawPath(mPopMaskDiffPath, mPaint);
